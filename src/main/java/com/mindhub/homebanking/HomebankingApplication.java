...
public class HomebankingApplication {
	...
	public CommandLineRunner initData(ClientRepository clientRepository, AccountRepository accountRepository, TransactionRepository transactionRepository, LoanRepository loanRepository, ClientLoanRepository clientLoanRepository, CardRepository cardRepository) {
		return (args -> {
			// 1° Creating clients
			Client client1 = new Client("Melba", "Morel", "melba@mindhub.com", passwordValidator("Abcd1234*"));
			client1.setPassword(passwordEncoder.encode(client1.getPassword()));
			Client client2 = new Client("Francisco", "DEramo", "franciscoderamo@gmail.com", passwordValidator("Abcd1234*"));
			client2.setPassword(passwordEncoder.encode(client2.getPassword()));
			Client admin = new Client("admin", "admin", "admin@correo.com", passwordValidator("Abcd1234*"));
			admin.setPassword(passwordEncoder.encode(admin.getPassword()));
			try {
				passwordValidator("Abcd1234*");
			...
			// 1° Creating Card
			Card card1 = new Card(client1.getLastName() + " " + client1.getFirstName(),CardType.DEBIT, CardColor.GOLD, "1256-2456-4584-9103", (short) 456, LocalDate.now(), LocalDate.now().minusYears(1));
			...
			Card card3 = new Card(client2.getLastName() + " " + client2.getFirstName(), CardType.CREDIT, CardColor.SILVER, "4584-9103-1256-2456", (short) 164, LocalDate.now(), LocalDate.now().plusYears(5));
			card1.setIsExpired(true);
